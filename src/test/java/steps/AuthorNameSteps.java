...
public class AuthorNameSteps {
	...
	public void user_enters_valid_authorName() {
		String validParam = "user:";
		response = WebServiceRunner.runGetRequestWithAuthorName(new AuthorNameSteps().contenttype_and_AcceptType_is_Json(), authorName, validParam);	
	}
